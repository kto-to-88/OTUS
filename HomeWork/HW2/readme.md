...
![](./jpg/2-9.PNG)
 ...
 ##### Вопросы:
 ##### Записаны ли в таблице МАС-адресов какие-либо МАС-адреса? ОТВЕТ: Да. Указан MAC, который подклчен к порту.
 ##### Какие МАС-адреса записаны в таблице? ОТВЕТ: MAC порта подключенного коммутатора. С какими портами коммутатора они сопоставлены и каким устройствам принадлежат? ОТВЕТ: MAC принадлежит порту подключенного коммутатора. 
 ##### Если вы не записали МАС-адреса сетевых устройств в шаге 1, как можно определить, каким устройствам принадлежат МАС-адреса, используя только выходные данные команды show mac address-table? Работает ли это решение в любой ситуации? ОТВЕТ: Комманда "show mac address-table" покажет МАС устройства 2 уровня, подключенное непосредственно к порту.
...
S2# clear mac address-table dynamic
 ...
 ##### Вопросы:
 ##### Указаны ли в таблице МАС-адресов адреса для VLAN 1? ОТВЕТ: Да. Указаны ли другие МАС-адреса? ОТВЕТ: нет.
 ##### Через 10 секунд введите команду show mac address-table и нажмите клавишу ввода. Появились ли в таблице МАС-адресов новые адреса? ОТВЕТ: Да. Указан MAC порта подключенного коммутатора.
