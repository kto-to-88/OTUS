...
![](./jpg/2-9.PNG)
 ...
 ##### ОТВЕТ: Да. Указан MAC, который подклчен к порту.
 ##### Какие МАС-адреса записаны в таблице? 
 ##### ОТВЕТ: MAC порта подключенного коммутатора. С какими портами коммутатора они сопоставлены и каким устройствам принадлежат? 
...
S2# clear mac address-table dynamic
 ...
 ##### ОТВЕТ: Да. Указан MAC порта подключенного коммутатора.
