...
Ответ:
Данные шлюза по умолчанию получены с помощью функции DHCPv6.
...
Ответ: Локальный адрес канала не маршрутизируется (его не пропускает маршрутизатор). Поэтому для каждого L2 сегмента он является уникальным.

2.*Какой идентификатор подсети в индивидуальном IPv6-адресе 2001:db8:acad::aaaa:1234/64?*

Ответ: ::/64 - Выполнив логическое ИЛИ получим данный идентификатор. Исключим идентификатор глобальной маршрутизации.
![](./jpg/net.PNG)
