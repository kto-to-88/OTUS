...
![](./jpg/lab1-3.PNG)
  * Закроем досуп для привелигированного режима :
    ...
    введём "conf t", затем "enable secret cisco". Параметр secret хранит пароль в конфигурации коммутатора в зашифрованном виде и при попытки зайти в привелигированнй режим требуется ввод пароля.
