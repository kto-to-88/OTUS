...
Конфигурация отображена.
  ...
  Эхо-запрос работает корректно.
    
  #### 3.3 Протестируем возможность удаленного управления с помощью Telnet.
   
  ![](./jpg/lab1-6.PNG)

  Удалённое управление посредством Telnet работает корректно. 
