...
**В части 4 необходимо настроить маршрутизатор R1 в качестве сервера NTP, а коммутатор S1 в качестве клиента NTP маршрутизатора R1.**
...
```
R1#show clock 
14:15:12.529 UTC Fri Apr 17 2026
```
...
|-----------------:|:---------------|-----------------------------|------------------------------------:|
|Fri Apr 17 2026   | 14:15:12.529   | 		      UTC             |             R1                      | 
...
```
R1#clock set 14:15:11  17 april 2026
```
...
**b.	Настройте S1 и S2 в качестве клиентов NTP. Используйте соответствующие команды NTP для получения времени от интерфейса G0/0 R1,**
...
*~10.22.0.1     127.127.1.1     4    9        16      377    11.00          -5.00             0.12
...
```
S1#show clock 
14:37:41.902 UTC Fri Apr 17 2026

S2#sh clock 
14:42:58.403 UTC Fri Apr 17 2026
```
**Вопрос для повторения**
**Для каких интерфейсов в пределах сети не следует использовать протоколы обнаружения сетевых ресурсов? Поясните ответ.**
***Для пограничных интерфейсов сети. Хакеры могут воспользоваться информацией о системе и её уязвимостей, чтобы организовать атаку.***
