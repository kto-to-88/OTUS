...
***sticky подразумевает постоянную привязку к порту. Поэтому таймер не имеет смысла.***

**2.	Что касается безопасности порта на S2, если вы загружаете скрипт текущей конфигурации на S2, почему порту 18 на PC-B никогда не получит IP-адрес через DHCP?**

***Не понимаю про какой скрипт идёт речь...***

**3.	Что касается безопасности порта, в чем разница между типом абсолютного устаревания и типом устаревание по неактивности?**

***абсолютное устаревание - устаревание по истечению времени, не зависимо от того есть трафик или нет, устаревание по неактивности - если нет трафика в течении заданного времени.***
